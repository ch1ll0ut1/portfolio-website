...
export const services: ServiceData[] = [
    ...
    },
    {
        ...
        description: 'I help businesses integrate AI tools and automate processes to improve efficiency and user experience.',
        features: [
            'AI tool evaluation & selection',
            'Process automation with AI',
            'Chatbot & conversational AI integration',
            'AI-powered feature implementation',
            'Team training on AI tools & best practices',
        ],
        icon: Zap,
    },
    {
